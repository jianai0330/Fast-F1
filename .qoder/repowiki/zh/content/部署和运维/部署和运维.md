...
SV["docs/setup_versioning.sh<br/>版本化管理"]
end
subgraph "核心库"
...
- 文档构建系统
  - GitHub Actions 工作流支持版本化文档构建与部署。
  - 文档版本化管理脚本支持多版本组织与版本切换。
...
DocBuild["文档构建<br/>.github/workflows/docs.yml"]
Versioning["版本化管理<br/>docs/setup_versioning.sh"]
Client --> API
API --> DB
API --> Cache
API --> Scheduler
...
### 文档版本化管理（docs/setup_versioning.sh）
- 功能要点
  - 组织多版本文档结构，最新版本位于网站根目录，旧版本和开发版本位于子目录。
  - 生成主题版本切换器所需的 JSON 文件。
  - 支持版本移动、最新版本识别和版本 JSON 生成。
- 运维建议
  - 在版本化文档构建后自动运行此脚本。
  - 确保版本目录结构清晰，便于维护和清理。
